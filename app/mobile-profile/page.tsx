...
export default function MobileProfilePage() {
  ...
  // redirect ke desktop jika layar >= 768px
  useEffect(() => {
  ...
  // navigasi ke submenu di page.tsx via query param
  const goTo = (menu: string) => {
    router.push(`/?active=${menu}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white px-4 py-3.5 flex items-center gap-3 border-b border-gray-100 sticky top-0 z-10">
        ...
        <h1 className="font-semibold text-gray-800 text-sm">Profil Saya</h1>
      </div>
